<template>
  <div class="max-w-xl mx-auto px-6 py-16 text-center">
    <h1 class="font-display text-4xl mb-6 tracking-tight">Annulation de votre réservation</h1>
...
onMounted(async () => {
  try { await $fetch(`${config.public.apiUrl}/bookings/${route.params.cancelToken}/cancel`) }
