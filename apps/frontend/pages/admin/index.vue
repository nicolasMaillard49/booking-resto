...
<template>
  <div>
    ...
    <template v-else-if="overview">
      ...
      <div class="bg-white rounded-xl border border-neutral-100 p-4 sm:p-6">
        ...
        <div class="flex items-end gap-2 h-32">
          <div v-for="d in overview.chart7d" :key="d.date" class="flex-1 flex flex-col items-center">
            <div class="w-full bg-primary-500 rounded-t transition-all" :style="{ height: `${(d.couverts / maxCouverts) * 100}%` }"></div>
